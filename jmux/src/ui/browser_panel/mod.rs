...
pub fn create_browser_widget_with_profile(
    ...
    if let Some(ucm) = web_view.user_content_manager() {
        ucm.register_script_message_handler("jmux_console", None);
                ...
                function hook(level) {
                    return function() {
                        ...
                        try {
                            ...
                            window.webkit.messageHandlers.jmux_console.postMessage(level + ': ' + msg);
                        } catch(e) {}
                    };
                }
        ...
        ucm.connect_script_message_received(Some("jmux_console"), move |_ucm, value| {
